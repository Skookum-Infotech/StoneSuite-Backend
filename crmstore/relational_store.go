...
var customerFields = []cfield{
	{"company_name", "customer_name", kStr, true},
	{"first_name", "customer_authorized_person_fname", kStr, true},
	{"last_name", "customer_authorized_person_lname", kStr, true},
	{"email", "customer_contact_email", kStr, true},
	{"phone", "customer_primary_phonenum", kStr, true},
	{"address", "customer_addr_line1", kStr, true},

	{"customer_type_id", "customer_type", kFK, false},
	{"ar_status_id", "customer_ar_status", kFK, false},
	{"payment_terms_id", "customer_payment_terms", kFK, false},
	{"currency_id", "customer_currency", kFK, false},
	{"country_id", "customer_addr_country", kFK, false},
	{"state_id", "customer_addr_state", kFK, false},
	{"lead_source_id", "customer_lead_source", kFK, false},
	{"contact_method_id", "customer_preferred_contact_method", kFK, false},

	{"dba_name", "customer_dba_name", kStr, false},
	{"tax_id", "customer_tax_id", kStr, false},
	{"is_child", "customer_is_child", kBool, false},
	{"parent_company", "customer_parent_company", kFK, false},
	{"accounts_email", "customer_accounts_email", kStr, false},
	{"addl_email", "customer_addl_email", kStr, false},
	{"alt_phonenum", "customer_alt_phonenum", kStr, false},
	{"faxnum", "customer_faxnum", kStr, false},
	{"website", "customer_cmpny_website", kStr, false},
	{"addr_line2", "customer_addr_line2", kStr, false},
	{"addr_suitenum", "customer_addr_suitenum", kStr, false},
	{"addr_city", "customer_addr_city", kStr, false},
	{"addr_zip", "customer_addr_zip", kStr, false},

	{"is_bill_as_primary", "customer_is_bill_as_primary", kBool, false},
	{"bill_addr_line1", "customer_bill_addr_line1", kStr, false},
	{"bill_addr_line2", "customer_bill_addr_line2", kStr, false},
	{"bill_addr_suitenum", "customer_bill_addr_suitenum", kStr, false},
	{"bill_addr_city", "customer_bill_addr_city", kStr, false},
	{"bill_addr_state", "customer_bill_addr_state", kFK, false},
	{"bill_addr_zip", "customer_bill_addr_zip", kStr, false},
	{"bill_addr_country", "customer_bill_addr_country", kFK, false},

	{"is_ship_as_primary", "customer_is_ship_as_primary", kBool, false},
	{"ship_addr_line1", "customer_ship_addr_line1", kStr, false},
	{"ship_addr_line2", "customer_ship_addr_line2", kStr, false},
	{"ship_addr_suitenum", "customer_ship_addr_suitenum", kStr, false},
	{"ship_addr_city", "customer_ship_addr_city", kStr, false},
	{"ship_addr_state", "customer_ship_addr_state", kFK, false},
	{"ship_addr_zip", "customer_ship_addr_zip", kStr, false},
	{"ship_addr_country", "customer_ship_addr_country", kFK, false},

	{"lead_score", "customer_lead_score", kInt, false},
	{"expected_close_date", "customer_expected_close_date", kDate, false},
	{"expected_deal_value", "customer_expected_deal_value", kDec, false},
	{"last_contacted_date", "customer_last_contacted_date", kDate, false},
	{"do_not_contact", "customer_do_not_contact", kBool, false},
	{"internal_notes", "customer_internal_notes", kStr, false},

	{"sales_rep_user_id", "customer_sales_rep_user_id", kFK, false},
	{"price_level_id", "customer_price_level", kFK, false},
	{"is_tax_exempt", "customer_is_tax_exempt", kBool, false},
	{"tax_exempt_reason", "customer_tax_exempt_reason", kStr, false},
	{"tax_exempt_cert_num", "customer_tax_exempt_cert_num", kStr, false},
	{"tax_exempt_cert_file_id", "customer_tax_exempt_cert_file_id", kStr, false},
	{"tax_exempt_expiry_date", "customer_tax_exempt_expiry_date", kDate, false},
	{"sales_tax_percent", "customer_sales_tax_percent", kDec, false},
	{"credit_limit", "customer_credit_limit", kDec, false},
	{"is_credit_lock", "customer_is_credit_lock", kBool, false},
	{"credit_lock_reason", "customer_credit_lock_reason", kStr, false},

	{"total_balance", "customer_total_balance", kDec, false},
	{"deposit_balance", "customer_deposit_balance", kDec, false},
	{"overdue_balance", "customer_overdue_balance", kDec, false},
	{"days_overdue", "customer_days_overdue", kInt, false},
}
...
var leadProspectRequired = []string{
	"lead_source_id", "lead_score", "expected_close_date",
	"expected_deal_value", "last_contacted_date", "contact_method_id",
}
