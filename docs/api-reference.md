...
| Method | Path | Requires | Handler |
|---|---|---|---|
| `GET` | `/api/tenant/company-locations` | staff token + tenant | `companyLocationOps.List` |
| `POST` | `/api/tenant/company-locations` | staff token + tenant | `companyLocationOps.Create` |
| `DELETE` | `/api/tenant/company-locations/{id}` | staff token + tenant | `companyLocationOps.Delete` |
| `PATCH` | `/api/tenant/company-locations/{id}` | staff token + tenant | `companyLocationOps.Update` |
| `POST` | `/api/tenant/company-locations/{id}/default` | staff token + tenant | `companyLocationOps.SetDefault` |

### company-profile

| Method | Path | Requires | Handler |
|---|---|---|---|
| `GET` | `/api/tenant/company-profile` | staff token + tenant | `companyProfileOps.GetProfile` |
| `PUT` | `/api/tenant/company-profile` | staff token + tenant | `companyProfileOps.UpdateProfile` |
| `DELETE` | `/api/tenant/company-profile/logo` | staff token + tenant | `companyProfileOps.DeleteLogo` |
| `PUT` | `/api/tenant/company-profile/logo` | staff token + tenant | `companyProfileOps.UploadLogo` |
...
| Method | Path | Requires | Handler |
|---|---|---|---|
| `GET` | `/api/tenant/dashboard/widgets/accounting-snapshot/data` | staff token + tenant | `dashboardUI.AccountingSnapshot` |
| `GET` | `/api/tenant/dashboard/widgets/ar-outstanding/data` | staff token + tenant | `dashboardUI.ArOutstanding` |
| `GET` | `/api/tenant/dashboard/widgets/inventory-alerts/data` | staff token + tenant | `dashboardUI.InventoryAlerts` |
| `GET` | `/api/tenant/dashboard/widgets/kpi-strip/data` | staff token + tenant | `dashboardUI.KpiStrip` |
| `GET` | `/api/tenant/dashboard/widgets/material-consumption/data` | staff token + tenant | `dashboardUI.MaterialConsumption` |
...
| `GET` | `/api/tenant/dashboard/widgets/purchases-status/data` | staff token + tenant | `dashboardUI.PurchasesStatus` |
| `GET` | `/api/tenant/dashboard/widgets/recent-records/data` | staff token + tenant | `dashboardUI.RecentRecords` |
