...
func SendPasswordResetEmail(recipientEmail, recipientName, resetLink string) error {
	...
	body := fmt.Sprintf(`
		...
		<body style="font-family: Arial, sans-serif; color: #333;">
			...
			<p><a href="%s" style="background-color: #d97706; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Reset Password</a></p>
			<p>If the button does not work, copy and paste this link into your browser:</p>
			<p>%s</p>
			<p>This link expires in 24 hours. If you did not request a password reset, you can safely ignore this email — your password will not change.</p>
			<p>Best regards,<br>StoneSuite Team</p>
		</body>
		</html>
