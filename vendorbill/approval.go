...
// Reject sends a vendor bill that is awaiting approval back to Draft on
...
func Reject(ctx context.Context, pool *pgxpool.Pool, uuid string, actorEmployeeID int, callerIsSuperAdmin bool, reason string) (*VendorBill, error) {
