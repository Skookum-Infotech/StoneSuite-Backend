...
func TestResolver_Resolve(t *testing.T) {
	...
	if !ok || dt != query.TypeString || !strings.Contains(expr, "vendor_payment_number") {
...
func TestResolver_SortExpr(t *testing.T) {
	...
	if !ok || dt != query.TypeNumber || expr != "vp.vendor_payment_amount" {
...
func TestResolver_SearchPredicate(t *testing.T) {
	...
	if !strings.Contains(pred, "vp.vendor_payment_number ILIKE") || !strings.Contains(pred, "vp.vendor_payment_vendor_name ILIKE") {
